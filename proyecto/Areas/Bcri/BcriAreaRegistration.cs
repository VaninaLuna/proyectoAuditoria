    ...
    public class BcriAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            context.MapRoute(
                ...
                new[] { "proyecto.Areas.Bcri.Controllers" } // Parameter defaults
            );
            ...
            context.MapRoute(
                ...
                new[] { "proyecto.Areas.Bcri.Controllers", "proyecto.Controllers" } // Parameter defaults
            );
            ...
            context.MapRoute(
                ...
                new[] { "proyecto.Areas.Bcri.Controllers", "proyecto.Controllers" }
            );
			...
			context.MapRoute(
              ...
              namespaces: new[] { "proyecto.Areas.Bcri.Controllers", "proyecto.Controllers" }
            );
